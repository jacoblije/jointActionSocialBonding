...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# '/Library/Frameworks/R.framework/Resources/bin/R' --no-site-file\ \ \textbackslash{}\\\#\#\ \  --no-environ --no-save --no-restore --quiet CMD INSTALL\ \ \textbackslash{}\\\#\#\ \  '/private/var/folders/0p/39cmn5sj3355scsq\_n6nq3440000gq/T/Rtmp7QDmdE/devtools9f76ede5555/crsh-papaja-f41a7cc'\ \ \textbackslash{}\\\#\#\ \  --library='/Library/Frameworks/R.framework/Versions/3.5/Resources/library'\ \ \textbackslash{}\\\#\#\ \  --install-tests}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(med.out.postExperiment, main = "{}Mediation Model"{}): object 'med.out.postExperiment' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(med.out.postExperiment.High, main = "{}Mediation Model: High"{}): object 'med.out.postExperiment.High' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(med.out.postExperiment.Low, main = "{}Mediation Model: Low"{}): object 'med.out.postExperiment.Low' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(predvars, data, env): object 'groupPerfChangePrePostNorm' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in confint.merMod(perfBondingChangeCondition.lmer, method = "{}Wald"{}, : object 'perfBondingChangeCondition.lmer' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in hist(perfBondChangeResid, freq = FALSE, main = "{}Distribution of M2.3 residuals \textbackslash{}n (standardised)"{}, : object 'perfBondChangeResid' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(perfBondingChangeCondition.lmer, main = "{}Scatterplot of M2.3 Residuals \textbackslash{}n (standardised)"{}): object 'perfBondingChangeCondition.lmer' not found}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(perfBondingChangeInfl, which = "{}cook"{}, main = "{}M2.3 Influential cases \textbackslash{}n (Cook's Distance)"{}, : object 'perfBondingChangeInfl' not found}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(med.out.groupPerfClickChange.High,} \hlkwc{main} \hlstd{=} \hlstr{"Mediation Model: High"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(med.out.groupPerfClickChange.High, main = "{}Mediation Model: High"{}): object 'med.out.groupPerfClickChange.High' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(med.out.groupPerfClickChange.Low, main = "{}Mediation Model: Low"{}): object 'med.out.groupPerfClickChange.Low' not found}}\end{kframe}
\end{knitrout}
