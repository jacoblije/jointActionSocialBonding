...
\section{Vignette: My first assignment at the National Tournament in Qingdao \label{sect:qingdaoVignette}}
...
In the present study, I address these knowledge gaps in evolutionary approaches to group exercise through an ethnographic study of the social cognition of joint action among professional Chinese rugby players.  Based on emerging research from the social cognition of joint action, in which it is increasingly understood that dynamical coupling of lower-cognitive mechanisms associated with movement regulation set the foundations for higher-cognitive processes such as social bonding and declarations of group membership, I predict a relationship between athletes' experience and perceptions of joint action and attitudes towards group membership.  Within this relationship I isolate the psychological construct of ``team click,'' which refers to athletes' tacit sense of quality of coordination in joint action.

This ethnographic study is reported in two chapters.  In the present chapter, I outline the predictions of the study, the method through which I collected ethnographic data, as well as the first part of the ethnographic results in which I describe the cultural contours of the research context. Specifically, I identify evidence for affordances specific to the sport of rugby and the cultural milieu of competitive sport in contemporary China.  In the next Chapter (Chapter 6), I report results that pertain specifically to the core hypotheses of this dissertation, namely, to the relationship between joint action and social bonding.  In particular, I highlight athlete's perceptions of performance in joint action, their experiences of phenomena associated with team click, and processes of group membership as relevant to study predictions.  In sum, the present chapter is designed to set the scene for an in depth analysis of evidence for the study's core predictions in Chapter 6.

\subsection{Social cognition of joint action among professional rugby players in China: recalibration of predictions}

In Chapter 2 (Theory HYPERLINK), I make a series of novel theoretical predictions concerning a relationship between joint action and social bonding.  These predictions are broadly relevant to group exercise contexts in which joint action and group formation processes are present.  A closer inspection of the specific group exercise context of rugby in contemporary China necessitates a recalibration of study predictions outlined in Chapter 2.  In particular, I expect that the generalisable cognitive mechanisms and systems dynamics outlined in Chapter 2 will operate with culturally specific contours that require careful consideration.  To comprehend the affordances that shape the social cognition of joint action in rugby in China, attention must be paid to the 1) joint action parameters of the sport, the historical-cultural context of the PRC, and the specific modern history of rugby in China.  Only by considering these dimensions together is it possible to interpret observable human behaviour in this setting, and in turn identify evidence for generalisable cognitive and evolutionary mechanisms relevant to scientific explanations of group exercise.

The predictions for this ethnographic study are divided into two sections.  In the first section, I make predictions about the specific cultural terrain of the research Context.  to observe behaviour at various levels of

 culturally ancient and socially dominant mode of Confucian relationalism interact with inputs from the modern history of sport in China and the specific history of the team sport of rugby to produce distinct patterns of behaviour.  I expect to observe this interaction at the level of 1) institutions, namely the Institute and the rugby program, 2) group membership, namely expression and endorsement of group identity, and 3) action and perception when participating in the joint action requirements of rugby.


Second, and with this specific cultural terrain in mind, I expect to observe evidence of the predictions outlined in Chapter 2. I expect to observe a positive relationship between perceptions of joint action and team click, 2) a positive relationship between perceptions of team click and social bonding.  In addition
...
\subsubsection{Team Factions\label{sect:teamFactions}}
