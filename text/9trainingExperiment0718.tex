 Team Click% File name: trainingExperimentFinalAnalysis.R
% Author: Jacob Taylor
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# '/Library/Frameworks/R.framework/Resources/bin/R' --no-site-file\ \ \textbackslash{}\\\#\#\ \  --no-environ --no-save --no-restore --quiet CMD INSTALL\ \ \textbackslash{}\\\#\#\ \  '/private/var/folders/0p/39cmn5sj3355scsq\_n6nq3440000gq/T/RtmpyyLPRS/devtools94ff6008bd19/crsh-papaja-29e6cb0'\ \ \textbackslash{}\\\#\#\ \  --library='/Library/Frameworks/R.framework/Versions/3.5/Resources/library'\ \ \textbackslash{}\\\#\#\ \  --install-tests}}
...
One factor, labelled ``Team Click'' was imposed on the data, which explained 47.7\% of the overall variance (SS Loading = 2). Guttmans \lambda = 0.7338611 and Cronbachs \alpha = 0.7664883 indicated that the data reduction was appropriate and reliable.
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in confint.merMod(groupPerfExpClick.controls, method = "{}Wald"{}, level = 0.95): object 'groupPerfExpClick.controls' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sem.model.fits(groupPerfExpClick.controls): object 'groupPerfExpClick.controls' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lsmip(groupPerfExpClick.controls, groupPerformance\_3Norm \textasciitilde{} condition): object 'groupPerfExpClick.controls' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `\$<-.data.frame`(`*tmp*`, groupPerfChangePrePost, value = integer(0)): replacement has 0 rows, data has 174}}
