...
%%Model 4
%\begin{figure}[htbp]
%    \includegraphics[scale =.4]{images/TEM4Hist.pdf}
%    \includegraphics[scale =.4]{images/TEM4Scatter.pdf}
%    \includegraphics[scale =.4]{images/TEM4QQNorm.pdf}
%    \includegraphics[scale =.4]{images/TEM4CooksD.pdf}
%    \caption{Model 4 Assumptions: The interaction between positive violation of group performance expectations and perceptions of joint action success predicts feelings of Team Click}
%    \label{fig:M4Assumptions}
%\end{figure}
