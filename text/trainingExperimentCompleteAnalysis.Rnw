...
\section{Abstract}
This study further tested the hypothesised relationship between joint action, team click, and social bonding in a controlled experimental environment.  58 Professional Chinese rugby players (Men = \Sexpr{length(which(twc$sex == 0)}) participated in a between-subjects design involving two manipulations of a common rugby training drill known as ``invasion drill'' \citep{Passos2011}.  In the ``low difficulty'' condition, were primed with information to suggest that the training drill would be very easy to complete (2/10 difficulty rating).  In the ``high difficulty'' condition, athletes were primed to expect the training drill to be relatively difficult (8/10 difficulty).
...
Athletes were notified (first via WeChat and then in a team meeting) that my research purpose was to trial a number of different rugby training drills selected from a recent report by World Rugby concerning training methods for rugby sevens.  I explained that training drills have been previously rated by a selection of international level coaches and players from all over the world (including Asia and China – i.e., at the World Rugby headquarters in Nanjing, China).  I explained that I plan to assess these World Rugby  ratings by testing some by replicating these drills with more rugby athletes in China.  I explained to athletes that I collect a range of data, including survey measures and video footage, which will be later analysed to assess individual performance of athletes in each training drill.  I will explain that athletes will be randomly assigned to small training groups (of eight) in order to complete each round of drills, which will involve both attack and defense components.  I emphasised that in each trial, athletes will be assessed on their performance in attack and defense, including their ability to coordinate in attack and defense with other teammates. Through this explantion, I hoped that reducing competitiveness and objective feedback about performance (winning/losing) will encourage athletes to more closely consult implicit feelings around joint-action when responding to questions associated with performance, team click, and social bonding.

Finally, I will explain that there will be a second round of drills also requiring groups of eight athletes, but the makeup of these groups may reshuffle depending on athletes preferences.  This detail allowed me to include a post-experiment bonding measure, in which I ask athletes to what extent they wish to continue to work with the same 8-athlete team in a subsequent round of competitive drills.
...
Permission was sought from the head coach of each of the four teams.  Coaches subsequently nominated athletes who were fit and able to complete the session without compromising existing training schedules.  Athletes were pseudo-randomly assigned to one of two conditions, however conditions were matched as much as possible according to average training age.

Once athletes were assigned to an experimental group, they were then added to a WeChat group and received the initial cover story for the experiment.  Athletes were told that the aim of the researcher was to trial a number of different rugby training drills selected from a recent report by World Rugby concerning training methods for rugby sevens.  These training drills had been previously rated by a selection of international level coaches and players from all over the world (including Asia and China), and the researcher planned to assess these ratings by testing by analysing how athletes react physiologically and psychologically to the demands of each drill.

Athletes were informed that collected data would include: pre- and post-experiment surveys and video footage, which would be later analysed to assess the performance of athletes in each respective drill.  Athletes were led to believe that the assessment of performance in the experiment would be based on video analysis of an individual's performance in attack and defense, including an athlete's ability to coordinate attack and defense with others.




Besides this outcome, athletes were provided with no other goals, besides completing the experimental drill to the best of their ability

I will emphasise that in each trial, athletes will be assessed on   I.e., there will not be an explicit competitive component of the drill.  In this way, I hope that reducing competitiveness and objective feedback about performance (winning/losing) will encourage athletes to consult implicit feelings around joint-action when responding to questions associated with performance, team click, and social bonding.
...
Approximately one hour prior to the experiment, Athletes learned


that the  a) very high amounts of uncertainty (for example, a value of 8 on a scale of 1 to 10), or alternatively b) very low amounts of uncertainty (a value of 2 on a scale of 1 to 10).

Athletes were primed with either a high difficulty or low difficulty
Athletes were lead to believe that each experiemntal group were performing different drills.

No other specific advice was given to each participant on how to achieve these aims so that we could observe the spontaneous interpersonal interactions of teammates without overprescriptive instructions.


Following a Following 4 practices attempts at the drill,  athletes will rotate through the 16 positions of the drill (4 attacking, 4 defending) over a total of 16 test trials of the drill.
Once permission was obtained from the head coach of each team, athletes were nominated for the study

 on a 2m high platfor.
...
Neither group nor individual confidence in ability to meet technical challenges differed significantly by condition.  The variance of the confidence in individual and group confidence appeared to be higher in the high difficulty condition,
