...
Introducing the specific group exercise context of this dissertation therefore requires a consideration of 1) the micro-level components and dynamics of joint action typical of rugby union (specifically rugby 7s), and 2) a description of the way in which these micro-level processes interact with, and are shaped by, the specific historical and cultural trajectory in which they are embedded---namely, sport in the People's Republic of China (PRC, or simply China).
  ...
  This theory embraces accumulating evidence that organic systems are engaged in the lifelong business of free energy minimisation.  Humans' success in biological pursuit can be largely explained by our capacity for joint action \citep{Tomasello2005a}.  In order to establish and sustain joint action with others, predictive models generated within the the nervous system couple with resources of the neuro-external environment.  Models and the affordances to which they are dynamically (i.e., not necessarily behaviourally) synchronised are grounded in physicality---the body and the physical features of the task-specific environment.  From this visceral and natural foundation grows a double helix of more and more elaborate couplings, which come to reflect more and more complex statistical regularities.  These patterned regularities are culture, conventionally construed \citep{Roepstorff2010}.  Importantly, the robustness of these predictive models of the world appear to depend crucially on the extent to which joint action clicks.  Team click is responsible for  generating positive, visceral, and agentic experiences, which may serve as the necessary pillars for social connections mediated by higher order cultural constructs.

  Not only are the immediate solicitations of other brains, bodies, and features of the immediate task environment important as affordances for joint action.  In addition, a broader \textit{field} of cultural affordances---made up of norms, conventions, and institutions---are also relevant \citep[cf.][]{Ramstead2016}.  By virtue of their dynamical linkages to lower order processes via bi-directional pathways of generative models, these more macro-contextual affordances also function to direct and finesse joint action in patterned and therefore predictable ways.   Anthropology, as a discipline with a proud history of attention to the details of cultural and ecological context, and now with an ever expansive methodological toolkit, is well positioned to offer empirical evidence for a novel theory of social bonding through joint action. In essence, anthropology is uniquely placed to traverse the entire continuum of natural and cultural affordances, and to generate and test scientific hypotheses \citep{Whitehouse2012,Fuentes2015}.

  Rugby union in contemporary China contains various layers affordances that require explanation.  Together, the standardised parameters (rules, regulations, conventions) of rugby union, the psychological and cultural patterns typically existing in mainland China, and the specific history of modern sport and rugby union in mainland China collectively shape observable behaviour.   The experience of professional rugby players in China is nested within various layers of China's modern history, defined by projects of governance, state building and participation in the international community.  The cultural affordances recruited to facilitate these political and social activities---of which sport is central---emanate from a range of sources both foreign and indigenous to China.  These affordances have evolved as the result of a modern history of confluence with and antagonism between China the world beyond China's sovereign borders.  As such, while the prescribed rules of rugby union are legislated by an international governing body and therefore in theory relatively consistent across the globe, the rugby played in China exhibits a style and quality that relates to the particular institutions, social norms, and culturally-shaped tendencies of action and perception specific to China.

  In the sections below, I introduce these three main contextual layers of the research setting, and conclude by updating theoretical predictions in light of the terrain of affordances likely present in joint action scenarios in rugby in China.  In addition, I explain the (unique) combination of qualifications that enabled me to conduct research in this specific context.
