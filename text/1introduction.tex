...
Fortunately, a paradigm shift in cognitive and behavioural sciences is shedding new light on human solutions to the challenge of joint action.  Recent advances in neuroimaging technologies \citep{Frith2007}, neurocomputational theories of brain function \citep{Friston2010,Frith2010,Yufik2013,Clark2013}, and constructive attempts to extend the theoretical paradigm of human social cognition to account for inter-individual processes of interaction and coordination \citep{Sebanz2006,Dale2014}, have amounted to a paradigm shift in cognitive science, in which it is now more clearly understood that cognitive processes relevant to joint action are distributed throughout brains, bodies, and the physical environment of the ecological niche in which they are situated.  As I explain below and in detail in Chapter ~\ref{chap:theory}, this shift in understanding of human cognition allows for a more powerful and fine-grained explanatory model of how joint action---and, in turn, social connection---could achieved between two or more participants.

Inspired originally by the mechanics of the electronic computer \citep{Liu2010a}, traditional individual-bound computational models of information processing tend to render movement as the final product of a linear sequence of sensory perception, amodal mental representation, and action selection \citep{Lewis2005}.  By contrast, the prevailing paradigm, which I consider in this dissertation, conceives of human cognition as a process of ``active inference'' \citep{Friston2010}.
Active inference promotes a conceptualisation of the human brain as driven by the overarching mandate of reducing ``free energy'' (informational uncertainty or entropy) in its interactions with the environment \citep{Friston2010,Carhart-Harris2014}.  The most effective way in which to adhere to this thermodynamic mandate is to pro-actively anticipate (predict) the external causes of sensory inputs.  Active inference \citep[and the predictive coding paradigm which it extends, see][]{Clark2013} proposes a radical inverse of traditional models of cognition that rely predominantly on bottom-up sensory inputs and top-down feature detection \citep{Marr1982}. Instead, active inference posits that top-down predictive models themselves shape perception and action, and the only information that travels forward (or from the ``bottom-up'') is the error signals that arise from discrepancies between predictions and the sensorium \citep{Clark2015}.

Active inference depicts a human cognitive system in which perception, mental simulation, emotion, and action are functionally and temporally integrated to manage uncertainty inherent in interactions with the environment \citep{Clark2013}.  In this conception, rather than being restricted to a dualistic either/or choice between functionally distinct cognitive modes of inference (e.g. habitual or mental, explicit or implicit, fast and slow \citep[cf.][]{Dienes1999,Kahneman2011}, active inference predicts that humans benefit from flexible deployment of of multiple strategies from a unified web of neural and extra-neural affordances \citep{Pezzulo2013,Clark2015}.  These strategies can be seen to like on a continuum, which ranges from more computationally intensive interoceptive (internal or mental) predictive models, on one end, to lower cognitive mechanisms of movement regulation that facilitate more direct coupling with the extra-neural resources of the task-specific environment, on the other \citep{Riley2011}.  Flexibility of active inferential strategies is enabled by a process akin to Bayesian statistical inference, whereby experience-induced prior expectations  act as precision weights that preference the processing of certain prediction errors over others \citep{Clark2015}.  In other words, each prediction is also conditioned by how likely we think the prediction will be true, based on previous experience. Higher precision weightings will promote processing of those prediction errors.  At the same time, recent research suggests that prediction errors deriving from predictions with no or very limited (i.e., high variance) prior probability distribution will be accompanied by positive reward \citep{Chetverikov2016}.

The inferences, emotions, and actions of predictive brains show evidence of being grounded in the environment in which they were produced \citep[in the same way that artificial neural nets show idiosyncrasies deriving from the training sets on which they began learning, see][]{Rao1999}, thus suggesting that the resources of the joint action environment, including the co-actors form an indispensable part of an individual's grasp and understanding of the world \citep{Pesquita2017}.
...
%explore the use of a variety of prediction-based learning routines as a means of grounding higher cognitive functions in the solid bedrock of sensorimotor engagements with the world


\section{When joint action clicks}

Active inference predicts that global success in real world joint action scenarios require flexible, moment-by-moment pre-emptive deployment of a range of perceptions and actions depending on the specific demands of the task environment.  From a free energy minimisation standpoint, there is evidence to suggest that human cognitive systems possess a tendency to maximise computational efficiency by spotting opportunities for intelligent use of cognitive resources afforded by the repeated calls high precision-weighted predictions (i.e., habits) or features of the environmental structure \citep{Clark2015}.
...
evolution, experience, or affective reward calculus:

Recalls the nature of interactive sport:
where the parameters of the activity are such that ideal states are not exact synchrony, but instead resemble synchrony breaking... once high precision certainty is achieved (the dark room)
...
Discussed as part of the theoretical framework outlined in Chapter 2, shared cultural knowledge can act as a ``coordination smoother'' \citep{Vesper2017} for joint action, enhancing the effectiveness and efficiency of joint action between co-participants who share a similar informational framework.  In one sense, the term ``culture'' can be understood as shared elements that provide standards for perceiving, believing, evaluating, communicating, and acting among those who share a language, a historical period, and a geographical location \citep{Triandis1996}.  Alternatively, as cultural psychologists Kitayama and Markus (2020, p. 422) explain, culture is a:
