...
Zhu and Shi were more or less in control of the team when I entered in 2015, despite their being signs that their authority may not have been rock solid. If I had understood as much about the machinations of politics and power in Chinese sport then as I do now, then perhaps the signal Wang was sending by not engaging in the huddle was a clear sign that the writing was on the wall for Zhu, and that Wang---a Beijing reisdent and Asian Games Bronze medalist---would eventually take his rightful place atop the Men's program.  Key senior players like Lu and Wei Wenxin complained to me constantly about Zhu and his approach to coacing and team management.  I could tell the women's coach Ma was frustrated by Zhu and his communication style.

In hindsight it is clear that Zhu and Shi were perhaps only ever going to be a temporary stop-gap; outsiders employed to come in and do the thankless job of ressurecting a sporting program rugby team from a shameful fall from grace.  But at the time, only four months into my first stint of ethnographic research, adn still largely unaquainted with (and without access to) the deep details of politics at the Institute, I was not prepared for what happened when I returned to Beijing from two weeks at home in Australia over Christmas.

When I returned to Beijing I stayed the night at my friend Kai's place, and the next morning I messaged head coach Zhu to ask when would be best to return to the Instutute to resume research.  His reply was brief and somewhat odd: ``You should be able to [return to the Institute], you should probably make contact with Han or maybe Coach Wang.'' (应该可以，你联系一下小龙呗，或王导呗).  This reply was a little bit opaque, but I didn't challenge it as was the norm with someone my senior.  Instead I contacted Han, asking if I could go to the Institute that evening and if the team had the afternoon off: ``Mmmm.. no training. I'm currently out (not at the Institute). Teacher Zhu and Coach Shi have left...now Wang is head coach.  You're still in Room 113 for the time being...'' (嗯嗯 休息 我在外面 朱老师跟石导走了. 现在由王重一主教练 你还是先住113)
...
And like just like that, Zhu and Shi were out of the job, and Wang had assumed the role of head coach of the men's team.  Han and Lu became his assistant coaches, and some weeks later, Zhu Jing, a classmate of Wang from CAU who represented Xinjiang province in the 2013 National Games, joined Wang as assistant coach in Beijing.  Soon after the change, there appeared to be a renewed energy in the team.  Senior players Han and Lu had been promoted and appeared to respond to this promotion with positivity and enthusiasm.  Both Wang, Han, and Lu had all been coached by Zheng Hongjun, the old boss of Chinese rugby, and they all saw eye-to-eye about training techniques.

Interestingly, when I returned to Beijing after a 10 day travel break in February, two of the athletes on trial at the Institute had since left.  When I asked senior athlete Wang Wei about these students, he suggested that they were ``they had interests with Old Zhu...Old Zhu said that he could solve their ``school problems'' (i.e. get them into uni). They were here to try to get in to University.'' (和老朱有利益关系，老朱说可以解决上学的问题 都是过来上学的).

(This was probably true for XG; LJX's story was a bit more complex.  He had a tough run with injury, and had persisted for some time through a number of painful shoulder injuries, notivceably stressed by the situation).

Tellingly, the day that I sat on the side of training talking to WW about Zhu and the trials connected to Zhu, a group of 4 new trialists from Hebei procince, introduced to Wang through his circle, arrived at the Institute and joined training.
