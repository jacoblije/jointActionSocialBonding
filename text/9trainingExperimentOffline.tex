...
\section{Results}
A total of 58 professional Chinese rugby players from two provincial programs were recruited for the study (men = 31, M(age) = 21.33 SD = 3.33, range = 16-29).  Athletes were recruited from two provincial rugby programs, 31 participants were athletes from Shandong province (men = 15, M(age) = 22.1) and the remaining 27 athletes were from Beijing province (men = 16, M(age) = 20.4).
...
The attributes of the overall sample of athletes are displayed in Table ~\ref{tab:athleteDescriptivesTrainingOverall}. The average training age of athletes was 4.22 years (SD = 2.11), with athletes having spent on average over 5.64 years in the team. 36\% of the sample were full-time employees of their provincial team, and the remaining athletes were either being employed on a full-time (but fixed term) contract
(800\%)), a ``student contract'' ((1600\%))), a short term training contract
((800\%))), or on a short-term trial basis ((200\%))).
Only 18 of 58 (31\%) of athletes declared that there were in the starting team of their respective provincial teams.
...
{\centering \includegraphics[width=\maxwidth]{figure/fullOutcomeAvgSessionBoxplot-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpClickAssumptionsHist-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpClickAssumptionsScatter-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpClickQQNorm-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpClickCooksD-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/jASgroupPerfExpClickScatterLM-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/jASgroupPerfExpClickScatterLMER-1}

}

\caption[Positive violation of Group Performance Expectations
 moderates the relationship between perceived Joint Action Success and Group Click]{Positive violation of Group Performance Expectations
 moderates the relationship between perceived Joint Action Success and Group Click}\label{fig:jASgroupPerfExpClickScatterLMER}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/jASgroupPerfExpClickIntHist-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/jASgroupPerfExpClickIntScatter-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/jASgroupPerfExpClick_int_controlsQQNorm-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/jASgroupPerfExpClick_intAssumptionsCooksD-1}
...
(
  \cooksD
  =
   % max(jASgroupPerfExpClickIntCooksD), see model assumptions in Appendix  ~\ref{fig:M1aAssumptions}
).
...
{\centering \includegraphics[width=\maxwidth]{figure/clickBondingConditionHist-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/clickBondingConditionScatter-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/clickBondingConditionQQNorm-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/clickBondingConditionCooksD-1}
...
\cooksD
<
  0.7884775, see model assumptions in Appendix  ~\ref{fig:M2Assumptions}
)
.
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpBondConditionScatter-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpBondingConditionHist-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpBondingConditionScatter-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpBondingConditionQQNorm-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfExpBondingConditionCooksD-1}
...
and all \cooksD were less than
  %max(jASgroupPerfExpClickIntCooksD)
(
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(med.out.groupPerfExp, main = "{}Group Click partially mediates relationship \textbackslash{}n between team performance expectation \textbackslash{}n violation and social bonding"{}): object 'med.out.groupPerfExp' not found}}\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfPrePostVariable-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/groupPerfPrePostPlot-1}

}

\caption[Pre-Experiment confidence in group performance and post-Experiment perceptions of group performance versus expectations]{Pre-Experiment confidence in group performance and post-Experiment perceptions of group performance versus expectations}\label{fig:groupPerfPrePostPlot}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/prePostClickPlot-1}
...
{\centering \includegraphics[width=\maxwidth]{figure/prePostBondingPlot-1}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
  \hlstd{perfClickTimeScatter} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(tlc,}
                            \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=time,} \hlkwc{y}\hlstd{=groupClickFactor1,}
                            \hlkwc{size}\hlstd{=groupPerfPPNorm))} \hlopt{+}
                            ...
                            \hlkwd{labs}\hlstd{(}\hlkwc{x}\hlstd{=} \hlstr{"Time"}\hlstd{,} \hlkwc{y}\hlstd{=} \hlstr{"Group Click"}\hlstd{)} \hlopt{+}  \hlcom{# Don't add shaded confidence region}
                            \hlstd{apatheme}
  \hlstd{perfClickTimeScatter}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{summary}\hlstd{(perfClickTime.lmer} \hlkwb{<-} \hlkwd{lmer}\hlstd{(groupClickFactor1} \hlopt{~} \hlstd{groupPerfPPNorm}\hlopt{*}\hlstd{time}
                                    \hlopt{+} \hlstd{(}\hlnum{1} \hlopt{|} \hlstd{englishName)}
                                    \hlopt{+} \hlstd{(}\hlnum{1} \hlopt{|} \hlstd{sessionName)}
                                    \hlstd{,} \hlkwc{data} \hlstd{= tlc}
                                    \hlstd{,} \hlkwc{REML} \hlstd{=} \hlnum{FALSE}
                                \hlstd{)}
        \hlstd{)}
\end{alltt}
\end{kframe}
