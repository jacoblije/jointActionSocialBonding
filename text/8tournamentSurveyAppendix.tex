\chapter{Appendix: Team click in a National Tournament study\label{app8:tournamentSurvey}}
...
% \end{equation}
 ...
 \input{images/MLM21aJointActionSuccessClick}
...
%\label{app8:MLM23a}
      ...
      \input{images/MLM23aJointActionSuccessBonding}
...
%\label{app8:MLM21b}
      ...
      % \input{images/MLM21bcTeamPerfExpcClick}
       ...
       %\begin{figure}[htbp]
        ...
        %\end{figure} \includegraphics[scale =.4]{images/MLM21bHist.pdf}
