...
<<descriptivesGroupPerformance, echo=F,eval=T>>=
  ...
  library(scales)
  tlcGroupPerformance$groupPerformanceExp[tlcGroupPerformance$time == 3] <- rescale(
                                                                                    tlcGroupPerformance$groupPerformanceExp[tlcGroupPerformance$time == 3],
                                                                                    to = c(0, 100),
                                                                                    from = c(-50, 50)
                                                                                    )
...
<<descriptivesIndividualPerformance, echo=F,eval=T>>=
  ...
  library(scales)
  tlcIndPerformance$indPerformanceExp[tlcIndPerformance$time == 3] <- rescale(tlcIndPerformance$indPerformanceExp[tlcIndPerformance$time == 3],
                                                                                to = c(0, 100), from = c(-50, 50))
...
<<performanceConditionPostTable, echo=F,eval=T>>=
  ...
  twcPerformancePost <- dplyr::rename(twcPerformancePost, Team = team, Condition = condition,
                                      ...
                                      IndividualComponentPerformance = indPerformancePost, GroupPerformVsExpected = groupPerformance_3,
                                      IndPerformVsExpected = indPerformance_3)
...
<<teamPerfExpClickScatter, fig.cap=''>>=
  ...
  groupPerfExpClickScatter +
              ...
              ylab("Group Click") +
              apatheme
              ggsave("teamPerfExpClickScatter.pdf")
@
...
(
  ...
  \CIstart
    \Sexpr{groupPerfExpClick.controls.CIs["conditionhigh", 1]}
  ,
    \Sexpr{groupPerfExpClick.controls.CIs["conditionhigh", 2]}
  \CIfinish
  \SE
    \Sexpr{coef(summary(groupPerfExpClick.controls))["conditionhigh","Std. Error"]},
  t(
    \Sexpr{coef(summary(groupPerfExpClick.controls))["conditionhigh","df"]}
  )
  =
    \Sexpr{coef(summary(groupPerfExpClick.controls))["conditionhigh","t value"]}
  ,
  \pvalue
    \Sexpr{coef(summary(groupPerfExpClick.controls))["conditionhigh","Pr(>|t|)"]}
)
and the interaction effect of group performance expectation violation and condition on click
(
  \betavec
    \Sexpr{coef(summary(groupPerfExpClick.controls))["groupPerformance_3Norm:conditionhigh","Estimate"]}
  \CIstart
    \Sexpr{groupPerfExpClick.controls.CIs["groupPerformance_3Norm:conditionhigh", 1]}
  ,
    \Sexpr{groupPerfExpClick.controls.CIs["groupPerformance_3Norm:conditionhigh", 2]}
  \CIfinish
  \SE
    \Sexpr{coef(summary(groupPerfExpClick.controls))["groupPerformance_3Norm:conditionhigh","Std. Error"]},
  t(
    \Sexpr{coef(summary(groupPerfExpClick.controls))["groupPerformance_3Norm:conditionhigh","df"]}
  )
  =
    \Sexpr{coef(summary(groupPerfExpClick.controls))["groupPerformance_3Norm:conditionhigh","t value"]}
  ,
  \pvalue
    \Sexpr{coef(summary(groupPerfExpClick.controls))["groupPerformance_3Norm:conditionhigh","Pr(>|t|)"]}
)
...
<<groupPerfExpClickAssumptionsHist, echo=F,eval=T>>=
  ...
  hist(groupPerfExpClickResid ,
       freq = FALSE,
       main = "Distribution of M1 residuals \n (standardised)",
       xlab = "Residuals")
...
<<groupPerfExpClickCooksD, echo=F,eval=T>>=
 ...
 library(influence.ME)
 groupPerfExpClickInfl <- influence(groupPerfExpClick.controls, obs = TRUE)
...
(
  \cooksD
  =
   \Sexpr{round(jASgroupPerfExpClickIntCooksDMAX, digits = 2)},
...
<<clickBondingConditionCooksD, echo=F,eval=T>>=
  ...
  library(influence.ME)
  clickBondingCondition.controls.Infl <- influence(clickBondingCondition.controls, obs = T)
  clickBondingCondition.controls.CooksD <- cooks.distance(clickBondingCondition.controls.Infl)
  clickBondingCondition.controls.CooksDMAX <- max(clickBondingCondition.controls.CooksD, na.rm = T) # 1.382886e+00 (row 28)
  plot(clickBondingCondition.controls.Infl,
          which = "cook",
          main = "M2 Influential Cases \n (Cook's Distance)",
          ylab = "participants",
          xlab = "cooks.distance")
...
all
\cooksD
  \Sexpr{round(clickBondingCondition.controls.CooksDMAX, digits = 2)}, see model assumptions in Appendix  ~\ref{fig:M2Assumptions}
)
.
...
<<groupPerfExpBondingConditionCooksD, echo=F,eval=T>>=
  #indluential cases
  #cook's distances all < 1, so no cause for concern, (Field 2012: 271)
  groupPerfExpBondingCondition.controls.Infl <- influence(groupPerfExpBondingCondition.controls, obs = T)
  groupPerfExpBondingCondition.controlsCooksD <- cooks.distance(
                                                      groupPerfExpBondingCondition.controls.Infl)
  groupPerfExpBondingCondition.controls.CooksDMAX <- max(
                                                      groupPerfExpBondingCondition.controlsCooksD,
                                                      na.rm = T) # 1.382886e+00 (row 28)
  plot(groupPerfExpBondingCondition.controls.Infl,
        which = "cook",
        main = "M3 Influential Cases \n (Cook's Distance)",
        ylab = "participants",
        xlab = "cooks.distance")
...
<<groupPerfExpClickMediationPlot, eval=T,echo=F>>=
  plot(med.out.groupPerfExp, main = "Mediation Model")
