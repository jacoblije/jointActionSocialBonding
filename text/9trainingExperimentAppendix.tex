...
%(see Appendix ~\ref{app5:clickPre}).
...
%For full description of survey items, see Appendix~\ref{app5:bondingPre})
...
%, see Appendix~\ref{app5:technicalCompetence}).
...
%(see Appendix~\ref{app5:TIPI} for full description).
...
%(see Table~\ref{tab:teamDisciplineCorrTable})
...
%%Prediction 2 (Post-Drill): Table
\input{images/TEM1groupPerfExpClickOffline}

%%Prediction 2 (Post-Drill): Assumptions
\begin{figure}[!htbp]
...
%%Prediction 2 (Pre- to Post-Drill): Table
\input{images/TEM21groupPerfExpClickChangeOffline}

%%Prediction 2 (Pre- to Post-Drill): Assumptions
\begin{figure}[!htbp]
...
%%Prediction 3.a Model assumptions (Post-Drill): Team Click predicts
\input{images/clickBondingTableOffline}

%%Prediction 3.a Model assumptions (Post-Drill): Team Click predicts Social Bonding
\begin{figure}[htbp]
...
%%Prediction 3.a Model assumptions (Pre- to Post-Drill): Team Click predicts Social Bonding
\input{images/groupClickBondingChangeOffline}


%%Prediction 3.a Model assumptions (Pre- to Post-Drill): Team Bonding
\begin{figure}[htbp]
...
%%Prediction 3.b Model assumptions (Post-Drill): Team Click predicts
\input{images/clickTeamBondingTable}

%%Prediction 3.a Model assumptions (Post-Drill): Team Click predicts Social Bonding to Team
\begin{figure}[htbp]
...
%%Prediction 3.a Model assumptions (Pre- to Post-Drill): Team Bonding
%\begin{figure}[htbp]
%    \includegraphics[scale =.4]{images/TEM22bTeamHist.pdf}
%    \includegraphics[scale =.4]{images/TEM22bTeamScatter.pdf}
%    \includegraphics[scale =.4]{images/TEM22bTeamQQNorm.pdf}
%    \includegraphics[scale =.4]{images/TEM22bTeamCooksD.pdf}
%    \caption{Prediction 3.b Model assumptions (Pre- to Post-Drill): Team Click Change predicts Social Bonding Change to the Provincial team (n = 53).}
%    \label{fig:M22bAssumptions}
%\end{figure}
...
%    \caption{Prediction 4.a Model assumptions (Post-Drill): Team Performance Vs Expectations predicts Social Bonding}
...
%    \caption{Model assumptions: Team Performance Vs Expectations predicts Social Bonding (Province).}
...
%    \caption{Model assumptions: Team Performance Vs Expectations predicts perceptions of Social Bonding}
