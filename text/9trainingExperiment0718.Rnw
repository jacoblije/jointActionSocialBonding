...
\myparagraph{Prediction 2.a: Feelings of group click predict feelings of social bonding to provincial team}
...
A LMER model (controlling for arousal, average trial performance outcome, and technical competence (subjective and objective)) revealed a strong positive relationship between feelings of group click and feelings of social bonding to provincial team,
