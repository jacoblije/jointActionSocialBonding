...
AGENCY:
The experience of agency in joint action appears to derive from a spectrum of sources, ranging from more conscious explicit experience of agency (Wegner 2004) to the more implicit experience of agency derived from action prediction and sensory outcome matching \citep{Blakemore2003}

Greater sensorial experience when an outcome is unexpected, rather than sourced from self or other \citep{Sato2008}

attributing sensory consequences to joint action partners is linked to cooperative success \citep{Chaminade2012}
