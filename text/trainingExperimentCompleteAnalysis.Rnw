...
\section{Abstract}
This study further tested the hypothesised relationship between joint action, team click, and social bonding in a controlled experimental environment.  58 Professional Chinese rugby players (men = 30) participated in a between-subjects design involving two manipulations of a common rugby training drill known as ``invasion drill'' \citep{Passos2011}.  In the ``low uncertainty'' condition, were primed with information to suggest that the training drill would be very easy to complete (2/10 difficulty rating).  In the ``high uncertainty'' condition, athletes were primed to expect the training drill to be relatively difficult (8/10 difficulty).
Pre and post survey measures were recorded, along with video footage of each experimental trial.  It was predicted that athletes in the high-uncertainty condition would experience higher levels of team click and social bonding owing to higher than expected positive violation of expectations around group performance.
Athletes in the ``low uncertainty'' condition would on average experience less positive violations of expectations, and thus would feel less strongly the phenomenon of ``team click'' and flow-on feelings of social bonding.  Further, it was predicted that athletes who experienced higher quality joint action would also experience higher levels of team click and social bonding.  Video footage was analysed for evidence of dynamic coupling between co-actors as well as defenders \citep{Schmidt2011,Richardson2012,Passos2012}, and these data were compared to psychological measures in order to explore a potential relationship between objective measures of coordination in joint action and psychological correlates.

\section{Introduction}
This dissertation explores the proposition that when athletes coordinate their behaviours they do so by making predictions about the state of the world.  In the case of joint action, the accuracy of these predictions rely on the behaviours of
of others---team mates and opposition. The previous chapter demonstrated a relationship between perceptions of joint action success and social bonding, fully mediated by the phenomenon of ``team click.'' A relationship between violation of expectations surrounding team performance and feelings of team click was also observed, but a model of the relationship between team performance expectation vioaltion and social bonding did not reliably fit the data.  The results of this naturalistic \textit{in situ} study are noteworthy and encouraging, but controlled experimental research is needed in order to more directly access causal mechanisms that underpin the relationship between joint action and social bonding.  How is it possible to manipulate conditions conducive to  perceived joint action success and team performance expectation violation?
...
This study required athletes to participate in a common rugby training drill, which was preceeded by one of two experimental primes—--a ``high uncertainty'' condition, or a ``low uncertainty'' condition.  The training drill, known as ``invasion drill,'' requires eight athletes, one sub-group of four attackers and two sub-groups of two defenders.  The   The primary aim of the drill is for the sub-group of 4 attacking players to successfully penetrate two consecutive lines of two defenders (also commonly known as a ``4 on 2 + 2'' drill).  The drill was conducted within a 22 x 15m rectangle marked by plastic cones (see ~\ref{fig:invasionDrill}).

In the invasion drill, The aim of the two defending sub-groups is to stop the attacking team from achieving the primary goal, by interfering with their coordination by halting the ball-carrier, or the ball in flight between attacking players.  One trial consisted of one attempt by the attacking sub-group to penetrate two defending sub-groups, and carrying the ball over the try line table

 This drill contains typical components of a game play “sub-phase,” requiring interpersonal coordination between both attacking and defending sub-groups.
...
\subsubsection{Experimental Conditions: high and low uncertainty}

Two different cover stories were developed for the same training drill in order to manipulate athletes’ expectations around the uncertainty of the impending joint-action task.

 by either over- or under-rating the difficulty of the impending training drill. One hour priorAthletes learned that the  a) very high amounts of uncertainty (for example, a value of 8 on a scale of 1 to 10), or alternatively b) very low amounts of uncertainty (a value of 2 on a scale of 1 to 10).   

In a pilot of the 4on2+2 training drill with junior athletes from the Beijing provincial team, n=10, athletes rated the drill on average 4.7/10, range = 3 to 7.  This difficulty rating was recorded following a training session that involved two other main training drills, a 2on1+1 attacking drill (avg. rating=2, range=1-4), and a 6on4 continuous attacking drill (avg. rating = 5.8, range=4-10).

APPENDIX:  Experiment primes
1. High uncertainty script (8/10)
The drill you will be participating in today involves four attackers and two phases of two defenders in a 15m x 25m channel.   International coaches have assessed this drill based on a number of different factors (including drill complexity, coordination, intensity, skill requirement, etc.), and a sample of professional rugby players from all over the world, including China, have rated this drill based on its difficulty.  World Rugby has combined these two measures and concluded that it is a very difficult drill for players to perform together successfully.  This drill was given a score of 77.5/100, which translates to a difficulty rating of about 8/10.  So the requirements of this drill—in coordinating both attack and defense—are quite high.

2. Low uncertainty script (2/10)
The drill you will be participating in today involves four attackers and two phases of two defenders in a 15m x 25m channel.   International coaches have assessed this drill based on a number of different factors (including drill complexity, coordination, intensity, skill requirement, etc.), and a sample of professional rugby players from all over the world, including China, have rated this drill based on its difficulty.  World Rugby has combined both of these measures and concluded that it is a very easy drill for players to perform together successfully.  This drill was given a score of 22.5/100, which translates to a difficulty rating of about 2/10.  So the requirements of this drill—in coordinating both attack and defense—are quite low.

Drill explanation – (constant across both conditions):
The drill will work as follows:  when I blow the whistle, the first group of four attackers will assemble on the diamond pattern of four cones and prepare to attack, while two lines of two defenders each will assemble on the assigned cones, 10m apart from each other.  When I blow the whistle a second time, the ball carrier at the top of the attacking diamond will tap the ball on his/her foot and proceed to engage the attack in a 4on2 scenario.  The goal of the attacking group is to penetrate both lines of defense without being held by the defenders.  After participating in the first line of defense, the first two defenders must stay put, and cannot follow the play and participate in the second line of defense.
...
Athletes completed survey questionnaires at three time points: 1) one day before the experiment, 2) immediately before the experiment after receiving the experimental prime (high or low uncertainty), and 3) once immediately following the completion of the experiment (TABLE).  At time 1 (baseline) athletes were asked about their impressions of recent individual and team performance, as well as their feelings of team click and social bonding (to the team as a whole).  At time 2 (post-manipulation, pre-experiment), athletes were asked questions about their expectations around their individual performance and the performance of their specific training group in the impending training drill.  At time 3 (post-experiment), athletes completed questions concerning their impression of their own performance and the performance of their specific training group, as well as their feelings of team click and social bonding to the team as a whole.

SURVEY ITEMS:
In the baseline survey, athletes answered questions on how they felt about:

In the post-manipulation, pre-experiment survey, athletes answered questions how they felt about:

In the post-experiment survey, athletes answered how they felt about:
...
Permission was sought from the head coach of each team, who subsequently nominated athletes who were fit and able to complete the session without compromising existing training schedules.  The experimental sessions were scheduled to occur directly before a scheduled training session.

Following 4 practices attempts at the drill,  athletes will rotate through the 16 positions of the drill (4 attacking, 4 defending) over a total of 16 test trials of the drill.
Once permission was obtained from the head coach of each team, athletes were nominated for the study


and experimental sessions were scheduled to take place directly before scheduled training session.
...
xtable(corstarsl(tlcTeamDiscipline))
...
Neither group nor individual confidence in ability to meet technical challenges differed significantly by condition.  The variance of the confidence in individual and group confidence appeared to be higher in the high uncertainty condition,
...
boxplot(groupConfidentTechnicalChallenges_2 ~ condition, data = twc) #this is only measured at time = 2!
#standard deviation seems to be bigger in high uncertainty condition:
...
library(car)
leveneTest(groupConfidentTechnicalChallenges_2 ~ condition, data = twc)
fligner.test(groupConfidentTechnicalChallenges_2 ~ condition, data = twc)
bartlett.test(groupConfidentTechnicalChallenges_2 ~ condition, data = twc)
library(stats)
...
var.test(high$indConfidenceChallenges_2, low$indConfidenceChallenges_2)
...
# high uncertainty condition looks like higher arousal annd higher variance
