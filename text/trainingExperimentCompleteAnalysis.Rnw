...
In the case that athletes were unable to participate in their assigned condition for reasons of injury (2) or unannounced unavailability (2), a dummy athlete, naive to the details of the study, was used to fill in as part of the 8 person drill.  In the two experimental conditions involving the Beijing women's team, two athletes in one drill and three athletes in another drill were unable to complete the experiment due to injury and sickness, and as such the drill was modified to be a 3 on 2 + 1 Invasion drill requiring only 6 athletes, instead of the 4 on 2 + 2 drill, which requied 8.  In the drill in which three athletes were missing, one dummy participant athlete stood in to make the 3 on 2 + 1 drill possible.
