...
# create high and low condition dfs:
tlcTeamPerformanceHigh <- subset(tlcTeamPerformance, Condition == "high")

tlcTeamPerformanceLow <- subset(tlcTeamPerformance, Condition == "low")
...
## create table one (high difficulty condition)
tableTeamPerfHigh_time <- CreateTableOne(vars = listVars,
                         strata = "Time",
                         data = tlcTeamPerformanceHigh,
                         factorVars = catVars
                         )

## create table which is printable
tableTeamPerformHighTime <- print(tableTeamPerfHigh_time,
                            quote = FALSE,
                            noSpaces = FALSE,
                            printToggle = FALSE
                            )
...
## print to latex file in wd
## this latex file will later be inputted
print(xtable(tableTeamPerformHighTime, type="latex",
                          label = "tab:teamPerfTimeLowTraining",
                          caption = "Athlete perceptions of \n team performance (high difficulty condition)"), file="teamPerfTimeHighTraining.tex")


## create table one (low difficulty condition)
tableTeamPerfLow_time <- CreateTableOne(vars = listVars,
                         strata = "Time",
                         data = tlcTeamPerformanceLow,
                         factorVars = catVars
                         )

## create table which is printable
tableTeamPerformLowTime <- print(tableTeamPerfLow_time,
                            quote = FALSE,
                            noSpaces = FALSE,
                            printToggle = FALSE
                            )
...
## print to latex file in wd
## this latex file will later be inputted
print(xtable(tableTeamPerformLowTime, type="latex",
                          label = "tab:teamPerfTimeLowTraining",
                          caption = "Athlete perceptions of \n group performance (low difficulty condition)"), file="teamPerfTimeLowTraining.tex")
