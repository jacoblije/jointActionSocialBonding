...
%	\include{text/abstract} % Create an abstract.tex file in the 'text' folder for your abstract.
...
\flushbottom
\include{text/1introduction}
%\include{text/2theoreticalContribution}
%\include{text/3ethnographicSetting}
%\include{text/4ethnographyResults}
%\include{text/5tournamentSurvey}
%\include{text/6trainingExperiment}
%\include{text/7generalDiscussion}
%\include{text/8conclusion}
