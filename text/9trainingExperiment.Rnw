...
# do the same for ind Performance confidence and expectations
  tlc$indPerfConfExp[tlc$time == 3] <- tlc$indPerformance[tlc$time == 3]
...
tlc$indPerfChangePrePost <- tlc$indPerformanceExpectations[tlc$time == 3] - tlc$indPerformance[tlc$time == 2]
...
\subsubsection{Prediction 2.1: perf -> click }
...
\subsubsection{Prediciton 2.2: change click -> change bonding }
...
\subsubsection{Prediction 2.3: perf - bonding}
...
\subsubsection{Prediction 2.3: performance - bonding}
...
<<groupPerfClickChangeMedPlotHigh, eval=T,echo=F>>=
  plot(med.out.groupPerfClickChange.High, main = "Mediation Model: High ")
  dev.copy(pdf, "groupPerfClickChangeMedPlotHigh.pdf")
  dev.off()
@

<<groupPerfClickChangeMedPlotLow, eval=T,echo=F>>=
  plot(med.out.groupPerfClickChange.Low, main = "Mediation Model: Low ")
  dev.copy(pdf, "groupPerfClickChangeMedPlotLow.pdf")
  dev.off()
@
