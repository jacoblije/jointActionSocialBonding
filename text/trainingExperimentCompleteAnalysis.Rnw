...
\input{.../images/clickBondConditionPost.tex}
%%
...
\input{.../images/factorsHigh.tex}
\input{.../images/factorsTimeLow.tex}
...
twc$groupPerformance_3 <- scale(twc$groupPerformance_3)
jASPerfExpCLick <- lm(groupClickPostFactor ~ jointActionSuccessPost*groupPerformance_3, data = twc)
...
jASGroupPerfExpClickScatter <- ggplot(twc, aes(x=jointActionSuccessPost,
                                      y=groupClickPostFactor, size=groupPerformance_3)) + geom_point()
...
teamPerfExpBondScatter <- ggplot(twc, aes(x=groupPerformance_3, y=groupBondingFactorPost,
                            color=condition)) + geom_point(shape = 1) +
                            geom_smooth(method=lm, se=FALSE)
...
<<teamPerfExpBondScatter1, fig.cap=''>>=
teamPerfExpBondScatter1 <- ggplot(twc, aes(x=groupPerformance_3, y=groupBondingFactorPost)) + geom_point(shape = 1) +
                            geom_smooth(method=lm, se=FALSE)
...
teamPerfExpBond.lm <- lm(groupBondingFactorPost ~ condition*groupPerformance_3, data=twc)
