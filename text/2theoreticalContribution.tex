...
Experimental evidence from the behavioural synchrony and mimicry literatures suggests that exact synchronisation of movement between co-actors in joint action may be a powerful source of trust and affiliation between co-actors in joint action.  Synchrony appears to be responsible for blurring of self-other agency, pro-social behaviour, and reinforcement cooperation \citep{Mogan2017}, and these effects could be underwritten by the activation of neurobiological reward systems \citep{}.  This evidence leads to the suggestion in group exercise contents that synchronisation of behaviour, in addition to physiological exertion, combine to generate a psychophysiological environment conducive to forging social bonds.

Synchronisation is defined as a process in which two independent components continuously influence each other toward greater entrainment (within a certain lag tolerance).

This influence works as a reciprocal imposition of attraction and constraints that allows the synchronising parties to reduce overall variance of their joint activity, making them more similar and more regular. 

  Strict behavioural synchrony, while encountered in some group activities such as in group dancing, military drills, or rowing, is in fact atypical of most real world instances of interpersonal behavioural coordination.  For the social high theory of group exercise (outlined in Chapter ~\ref{introduction}), synchrony is an obvious place to start, as it demonstrates motor and cognitive alignment between individuals

 is relatively easily to operationalise (in the form of in-phase or anti-phase time-locked behaviour) in experimental settings.
...
\myparagraph{Interoceptive predictive models
One effective way of minimising cognitive free energy in joint action scenarios is to generate interoceptive predictive models for joint action.
...
\myparagraph{Action-perception links}
 ...
 \myparagraph{Extra-neural direct coupling}
