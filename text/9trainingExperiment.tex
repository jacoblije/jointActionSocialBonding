...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate\_impl(.data, dots): Evaluation error: unused argument (high = "{}Overall"{}).}}\end{kframe}
\end{knitrout}
