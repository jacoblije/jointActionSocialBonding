...
\subsection{Prediction 1.a: Joint Action Success predicts Team Click}

BASIC XY RELATIONSHIP? (Post-Tournament Data)



\subsubsection{1.a Post-Tournament}
...
\subsubsection{1.a Pre- to Post-Tournament change}

  2.1.a $\Delta$Team Click $\sim$ $\Delta$Joint Action Success:
...
\subsubsection{1.a Overall Tournament}
NA
...
\subsection{Prediction 1.b: Team Performance Expectations predicts Team Click}

  \subsubsection{1.b Post-Tournament}
  ...
  \subsubsection{1.b Pre- to Post-Tournament change}
  ...
  \subsubsection{1.b Overall Tournament}
...
\subsection{Prediction 1.c: Joint Action Success predicts Team Click, moderated by Team Performance Expectations}
  ...
  \subsubsection{1.c Post-Tournament}
...
\subsubsection{1.c Pre- to Post-Tournament change}
...
\subsection{Prediction 2: Team Click predicts Social Bonding}
  ...
  \subsubsection{2 Post-Tournament}
  ...
  \subsubsection{2 Pre- to Post-Tournament change}
...
\subsection{Prediction 3.a: Joint Action Success predicts Social Bonding}

  \subsubsection{3.a Post-Tournament}
  ...
  \subsubsection{3.a Pre- to Post-Tournament change}
