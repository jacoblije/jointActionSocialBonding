...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: <text>:2:3: unexpected symbol\\\#\# 1: library(lmerTest\\\#\# 2:\ \  library\\\#\#\ \ \ \ \ \ \textasciicircum{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Invalid grouping factor specification, sessionName}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in confint.merMod(perfClickChangeCondition.lmer, method = "{}Wald"{}, : object 'perfClickChangeCondition.lmer' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in hist(groupPerfClickChangeResid, freq = FALSE, main = "{}Distribution of M2.1 residuals \textbackslash{}n (standardised)"{}, : object 'groupPerfClickChangeResid' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(perfClickChangeCondition.lmer, main = "{}Scatterplot of M2.1 Residuals \textbackslash{}n (standardised)"{}): object 'perfClickChangeCondition.lmer' not found}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(groupPerfChangeClickInfl, which = "{}cook"{}, main = "{}M2.1 Influential cases \textbackslash{}n (Cook's Distance)"{}, : object 'groupPerfChangeClickInfl' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in confint.merMod(clickBondingChangeCondition.lmer, method = "{}Wald"{}, : object 'clickBondingChangeCondition.lmer' not found}}\end{kframe}
\end{knitrout}
