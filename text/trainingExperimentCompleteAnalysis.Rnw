...
jASClick.intercept <- lmer(groupClickPostFactor ~ 1 + ( 1 |sessionNumber),
                            data = twc,
                            REML = F)
jASClick.main <- lmer(groupClickPostFactor ~ jointActionSuccessPost + ( 1 |sessionNumber),
                            data = twc,
                            REML = F)
...
jASClick.controls <- lmer(groupClickPostFactor ~ jointActionSuccessPost +
                            ...
                            ( jointActionSuccessPost |sessionNumber),
                            data = twc,
                            REML = F)
...
groupPerfExpClick.intercept <- lmer(groupClickPostFactor ~ 1 + ( 1 |sessionNumber),
                            data = twc,
                            REML = F)
...
groupPerfExpClick.controls <- lmer(groupClickPostFactor ~ groupPerformance_3Norm +
                            ...
                            subjectiveCompetenceFactor + objectiveCompetenceFactor +
                            (groupPerformance_3Norm|sessionNumber),
                            data = twc,
                            REML = F)
...
clickBonding.intercept <- lmer(groupBondingFactorPost ~ 1 + ( 1 |sessionNumber),
                            data = twc,
                            REML = F)
...
clickBonding.controls <- lmer(groupBondingFactorPost ~ groupClickPostFactor +
                            indPerformancePost + arousalFactorPost + fullOutcomeAvg +
                            subjectiveCompetenceFactor + objectiveCompetenceFactor +
                            (groupClickPostFactor|sessionNumber),
                            data = twc,
                            REML = F)
...
jASBonding.intercept <- lmer(groupBondingFactorPost ~ 1 + ( 1 |sessionNumber),
                            data = twc,
                            REML = F)
...
groupPerfExpBonding.intercept <- lmer(groupBondingFactorPost ~ 1 + ( 1 |sessionNumber),
                            data = twc,
                            REML = F)
