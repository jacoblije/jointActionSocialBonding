...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sem.model.fits(groupPerfExpClick.controls): (Pseudo-)R\textasciicircum{}2s are not yet supported for some model classes!}}
